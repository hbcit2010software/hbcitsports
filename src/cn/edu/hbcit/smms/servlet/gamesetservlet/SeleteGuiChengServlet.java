...
public class SeleteGuiChengServlet extends HttpServlet {

	/**查询大会基本规程前台显示以便修改
	 * Constructor of the object.
	 */
	public SeleteGuiChengServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//
		SetServices bs = new SetServices();
		//
		ArrayList adminList=new ArrayList();
		
		adminList = bs.seleteBySportsId(sportsid);
			HttpSession session=request.getSession();
			session.setAttribute("set", adminList);
			//out.println(adminList);
			response.sendRedirect("../set_guichengalter.jsp");
	}
