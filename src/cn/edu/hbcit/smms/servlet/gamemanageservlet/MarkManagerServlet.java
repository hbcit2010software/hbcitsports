...
public class MarkManagerServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public MarkManagerServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Department n = (Department)List.get(i);
			if (i > 0) {
				sb.append(",");
			}
			...
			sb.append("\"Department\":\"" + n.getDepartmentName() + "\"");
			sb.append("}");
		}
		sb.append("]");
		sb.append("}");
