 ...
 * @version 1.00  2012/6/15  新建
 */
public boolean addRecord(String plaName,String sportsName1,String recTime,String recLevel,int plaSex,String sor, String depName, int iteId){
	return re.addRecord(plaName, sportsName1, recTime, recLevel, plaSex, sor, depName, iteId);
}
/**
 * 修改记录
 * @param plaName 运动员名
