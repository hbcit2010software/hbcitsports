...
function adduser() {
	...
	diag.Height = 150;
	diag.Title = "修改跑道";
	diag.URL = "${pageContext.request.contextPath }/servlet/AdjustByHandServlet?str="+tt;
  ...
  <body>
 		...
 		<table class="stripe_tb">
             <c:forEach items="${ trackPlayers }" var="temp">
		 		<tr>
		     	   <td>${ temp.groupNum }</td><td>${ temp.players }</td><td><a href="#" onclick="adduser()" id="${ temp.nextFlag }">修改</a></td>
		     	</tr>
	          </c:forEach>
 		</table> 
