...
insert  into `t_scoreformat`(`id`,`format`,`reg`,`memo`) values (1,'##.##(##秒##)','/^[1-5]?\\d\\.\\d\\d$/','0秒00--59秒99'),(2,'#.##.##(#分##秒##)','/^[1-9]?\\.?[1-5]\\d\\.\\d\\d$/','0分0秒00--9分59秒99'),(3,'##.##.##(##分##秒##)','/^[1-5]?\\d\\.[1-5]\\d\\.\\d\\d$/','00分00秒00--59分59秒99'),(4,'#.##(#米##)','/^[1-2]\\.\\d\\d$/','00米00--2米99'),(5,'#.##(#米##)','/^[4-9]\\.\\d\\d$/','00米00--9米99'),(6,'##.##(##米##)','/^[1-2]?\\d\\.\\d\\d$/','00米00--29米99'),(7,'##.##(##米##)','/^[1-7]\\d\\.\\d\\d$/','00米00--79米99'),(9,'##.##(##米##)','/^\\d\\d\\.\\d\\d$/','00米00--99米99');
